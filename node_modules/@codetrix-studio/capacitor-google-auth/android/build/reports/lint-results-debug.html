...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 1 error and 8 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Sat Feb 07 11:14:40 NPT 2026 by AGP (8.2.1)</nav>
    </div>
  </header>
...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:10</span>: <span class="message">JCenter Maven repository is no longer receiving updates: newer library versions may be available elsewhere</span><br /><pre class="errorlines">
<span class="lineno">  7 </span>
<span class="lineno">  8 </span>buildscript {
<span class="lineno">  9 </span>    repositories {
<span class="caretline"><span class="lineno"> 10 </span>        <span class="warning">jcenter()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<span class="caretline"><span class="lineno"> 48 </span>    <span class="warning">jcenter()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 49 </span>    mavenCentral()
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/res/layout/bridge_layout_main.xml">../../src/main/res/layout/bridge_layout_main.xml</a>:2</span>: <span class="message">Class referenced in the layout file, <code>androidx.coordinatorlayout.widget.CoordinatorLayout</code>, was not found in the project or the libraries</span><br /><pre class="errorlines">
<span class="lineno">  1 </span><span class="prologue">&lt;?xml version="1.0" encoding="utf-8"?></span>
<span class="caretline"><span class="lineno">  2 </span><span class="error"><span class="tag">&lt;androidx.coordinatorlayout.widget.CoordinatorLayout</span><span class="attribute"> </span><span class="prefix">xmlns:</span><span class="attribute">android</span>=<span class="value">"http://schemas.android.com/apk/res/android"</span></span></span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:14</span>: <span class="message">A newer version of com.android.tools.build:gradle than 8.0.0 is available: 9.0.0. (There is also a newer version of 8.0.&#55349;&#56421; available, if upgrading to 9.0.0 is difficult: 8.0.2)</span><br /><pre class="errorlines">
<span class="lineno"> 11 </span>        google()
<span class="lineno"> 12 </span>    }
<span class="lineno"> 13 </span>    dependencies {
<span class="caretline"><span class="lineno"> 14 </span>        <span class="warning">classpath <span class="string">'com.android.tools.build:gradle:8.0.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 15 </span>        classpath <span class="string">'com.google.gms:google-services:4.3.15'</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:15</span>: <span class="message">A newer version of com.google.gms:google-services than 4.3.15 is available: 4.4.4</span><br /><pre class="errorlines">
<span class="lineno"> 12 </span>    }
<span class="lineno"> 13 </span>    dependencies {
<span class="lineno"> 14 </span>        classpath <span class="string">'com.android.tools.build:gradle:8.0.0'</span>
<span class="caretline"><span class="lineno"> 15 </span>        classpath <span class="warning"><span class="string">'com.google.gms:google-services:4.3.15'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 16 </span>    }
<span class="lineno"> 17 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:56</span>: <span class="message">A newer version of androidx.appcompat:appcompat than 1.6.1 is available: 1.7.1</span><br /><pre class="errorlines">
<span class="lineno"> 53 </span>dependencies {
<span class="lineno"> 54 </span>    implementation fileTree(dir: <span class="string">'libs'</span>, include: [<span class="string">'*.jar'</span>])
<span class="lineno"> 55 </span>    implementation project(<span class="string">':capacitor-android'</span>)
<span class="caretline"><span class="lineno"> 56 </span>    implementation <span class="warning"><span class="string">"androidx.appcompat:appcompat:$androidxAppCompatVersion"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 57 </span>    testImplementation <span class="string">"junit:junit:$junitVersion"</span>
<span class="lineno"> 58 </span>    androidTestImplementation <span class="string">"androidx.test.ext:junit:$androidxJunitVersion"</span>
<span class="lineno"> 59 </span>    androidTestImplementation <span class="string">"androidx.test.espresso:espresso-core:$androidxEspressoCoreVersion"</span></pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:58</span>: <span class="message">A newer version of androidx.test.ext:junit than 1.1.5 is available: 1.3.0</span><br /><pre class="errorlines">
<span class="lineno"> 55 </span>    implementation project(<span class="string">':capacitor-android'</span>)
<span class="lineno"> 56 </span>    implementation <span class="string">"androidx.appcompat:appcompat:$androidxAppCompatVersion"</span>
<span class="lineno"> 57 </span>    testImplementation <span class="string">"junit:junit:$junitVersion"</span>
<span class="caretline"><span class="lineno"> 58 </span>    androidTestImplementation <span class="warning"><span class="string">"androidx.test.ext:junit:$androidxJunitVersion"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 59 </span>    androidTestImplementation <span class="string">"androidx.test.espresso:espresso-core:$androidxEspressoCoreVersion"</span>
<span class="lineno"> 60 </span>    implementation <span class="string">'com.google.android.gms:play-services-auth:18.+'</span>
<span class="lineno"> 61 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:59</span>: <span class="message">A newer version of androidx.test.espresso:espresso-core than 3.5.1 is available: 3.7.0</span><br /><pre class="errorlines">
<span class="lineno"> 56 </span>    implementation <span class="string">"androidx.appcompat:appcompat:$androidxAppCompatVersion"</span>
<span class="lineno"> 57 </span>    testImplementation <span class="string">"junit:junit:$junitVersion"</span>
<span class="lineno"> 58 </span>    androidTestImplementation <span class="string">"androidx.test.ext:junit:$androidxJunitVersion"</span>
<span class="caretline"><span class="lineno"> 59 </span>    androidTestImplementation <span class="warning"><span class="string">"androidx.test.espresso:espresso-core:$androidxEspressoCoreVersion"</span></span>&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 60 </span>    implementation <span class="string">'com.google.android.gms:play-services-auth:18.+'</span>
<span class="lineno"> 61 </span>}
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:60</span>: <span class="message">Avoid using + in version numbers; can lead to unpredictable and unrepeatable builds (com.google.android.gms:play-services-auth:18.+)</span><br /><pre class="errorlines">
<span class="lineno"> 57 </span>    testImplementation <span class="string">"junit:junit:$junitVersion"</span>
<span class="lineno"> 58 </span>    androidTestImplementation <span class="string">"androidx.test.ext:junit:$androidxJunitVersion"</span>
<span class="lineno"> 59 </span>    androidTestImplementation <span class="string">"androidx.test.espresso:espresso-core:$androidxEspressoCoreVersion"</span>
<span class="caretline"><span class="lineno"> 60 </span>    implementation <span class="warning"><span class="string">'com.google.android.gms:play-services-auth:18.+'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 61 </span>}
</pre>
